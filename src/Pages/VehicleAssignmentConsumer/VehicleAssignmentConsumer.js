...
// Vehicle Assignment Consumer was created by exciteon Ajmal
import {
    CButton,
    CCard,
    CCol,
                    ...
                    <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={true}>
                        <CForm className="row g-3 m-2 p-1" onSubmit={handleSubmit}>
                            <CRow>
                                ...
                                <CCol xs={12} md={3}>
                                    <CFormLabel htmlFor="selectDocument">
                                        Select Document*{' '}
                                        {errors.selectDocument && (
                                            <span className="help text-danger">{errors.selectDocument}</span>
                                        )}
                                    </CFormLabel>
                                    <CFormSelect name="selectDocument"
                                        onFocus={onFocus}
                                        onBlur={onBlur}
                                        onChange={handleChange}
                                        className={`${errors.selectDocument && 'is-invalid'}`}
                                        size="sm"
                                        id="selectDocument"
                                        placeholder="">
                                ...
                                <CCol xs={12} md={3}>
                                    <CFormLabel htmlFor="test">
                                        Test*{' '}
                                        {errors.test && (
                                            <span className="help text-danger">{errors.test}</span>
                                        )}
                                    </CFormLabel>
                                    <CFormSelect name="test"
                                        onFocus={onFocus}
                                        onBlur={onBlur}
                                        onChange={handleChange}
                                        className={`${errors.test && 'is-invalid'}`}
                                        size="sm"
                                        id="test"
                                        placeholder="">
                                        <option hidden>Select</option>
