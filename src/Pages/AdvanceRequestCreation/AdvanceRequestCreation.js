...
// Advance request creation was created by exciteon Ajmal
import {
    CButton,
    CCard,
    CCol,
                    ...
                    <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={true}>
                        <CForm className="row g-3 m-2 p-1" onSubmit={handleSubmit}>
                            <CRow>
                                ...
                                <CCol xs={12} md={3}>
                                    <CFormLabel htmlFor="advanceAmtRequestCreation">
                                        Advance Amt*{' '}
                                        {errors.advanceAmtRequestCreation && (
                                            <span className="help text-danger">{errors.advanceAmtRequestCreation}</span>
                                        )}
                                    </CFormLabel>
                                    <CFormInput
                                        name="advanceAmtRequestCreation"
                                        onFocus={onFocus}
                                        onBlur={onBlur}
                                        onChange={handleChange}
                                        className={`${errors.advanceAmtRequestCreation && 'is-invalid'}`}
                                        size="sm"
                                        id="advanceAmtRequestCreation"
                                        placeholder=""
                                    />
                                </CCol>
